...
interface DownloadEnrollmentPdfButtonProps {
  enrollmentId: string
...
export function DownloadEnrollmentPdfButton({
  enrollmentId,
  enrollmentNumber,
  variant = "outline",
  className,
  showError = false,
}: DownloadEnrollmentPdfButtonProps) {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      a.href = url
      a.download = `inscription-${enrollmentNumber || enrollmentId}.pdf`
  ...
  return (
    <>
      ...
      >
        ...
        {isDownloading ? t.common?.loading || "Loading..." : t.enrollmentWizard?.downloadPdf || "Download PDF"}
      </Button>
