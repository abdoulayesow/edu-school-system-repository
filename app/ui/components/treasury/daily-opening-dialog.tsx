  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden">
        {/* Emerald accent bar for daily opening */}
          ...
          <div className="space-y-4">
            ...
            {step === 1 && (
              <>
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-medium">{reg.countedSafeAmount} (GNF)</Label>
                  <Input
                    type="text"
                    inputMode="numeric"
            ...
            {step === 2 && (
              <>
                ...
                {/* Float Amount Input */}
                <div className="space-y-2">
                  <Label className="text-sm font-medium">{reg.floatAmountLabel} (GNF)</Label>
                  <Input
                    type="text"
                    inputMode="numeric"
                    value={floatAmount}
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    {reg.standardFloat}: {formatCurrency(defaultFloatAmount)} GNF
                  </p>
                </div>
