...
export const fr = {
  ...
  clubs: {
    title: "Clubs",
    subtitle: "Gérer et inscrire des élèves aux clubs",
    adminTitle: "Gestion des Clubs",
    adminSubtitle: "Créer et gérer les clubs pour l'année scolaire",
    noPermission: "Vous n'avez pas la permission de voir les clubs.",

    // Summary cards
    totalClubs: "Total des Clubs",
    ...
    acrossAllClubs: "Dans tous les clubs",

    // Filters
    filterClubs: "Filtrer les Clubs",
    ...
    // Card info
    assignStudent: "Inscrire un Élève",
    full: "Complet",
    noClubs: "Aucun club trouvé",

    // Assign dialog
    assignStudentTitle: "Inscrire un Élève",
    searchAndAdd: "Rechercher et ajouter un élève à",
    searchStudentPlaceholder: "Rechercher par nom ou numéro d'élève...",
    noMatchingStudents: "Aucun élève correspondant",
    allEnrolled: "Tous les élèves sont déjà inscrits",
    showingLimited: "Affichage de 20 élèves. Utilisez la recherche pour filtrer.",

    // Messages
    clubCreated: "Club créé avec succès",
    clubUpdated: "Club mis à jour avec succès",
    ...
    categoryManagementDescription: "Organiser les clubs par catégories",
    categoryManagementHint: "Créez des catégories pour organiser vos clubs. Les catégories aident les élèves à trouver des clubs par type.",
    addCategory: "Ajouter une Catégorie",
    addCategoryDescription: "Créer une nouvelle catégorie pour organiser les clubs",
    editCategory: "Modifier la Catégorie",
    editCategoryDescription: "Mettre à jour les détails de la catégorie",
    deleteCategory: "Supprimer la Catégorie",
    createCategory: "Créer la Catégorie",
    updateCategory: "Mettre à jour la Catégorie",
    noCategories: "Aucune catégorie",
    createFirstCategory: "Créez votre première catégorie pour organiser les clubs",
    categoryNameEn: "Nom (Anglais)",
    categoryNameFr: "Nom (Français)",
    categoryNameEnPlaceholder: "ex. Sports",
    categoryNameFrPlaceholder: "ex. Sports",
    categoryDescription: "Description",
    categoryDescriptionPlaceholder: "Description optionnelle pour cette catégorie",
    categoryActiveHint: "La catégorie est visible pour les utilisateurs",
    categoryInactiveHint: "La catégorie est masquée pour les utilisateurs",
    displayOrder: "Ordre d'affichage",
    displayOrderHint: "Les numéros les plus bas apparaissent en premier",
    confirmDeleteCategory: "Êtes-vous sûr de vouloir supprimer cette catégorie ? Cette action est irréversible.",
    cannotDeleteCategoryWithClubs: "Cette catégorie ne peut pas être supprimée car elle contient des clubs. Veuillez d'abord réassigner ou supprimer les clubs.",
    club: "club",
    clubsLower: "clubs",

    // Payment options (enrollment flow)
    selectPaymentOption: "Sélectionner l'option de paiement",
    paymentType: "Type de paiement",
    oneTimePayment: "Paiement unique",
    oneTimePaymentDesc: "Payer la totalité des frais d'inscription",
    trimesterPayment: "Trimestre (3 mois)",
    trimesterPaymentDesc: "Payer pour 3 mois à la fois",
    monthlyPayment: "Paiement mensuel",
    monthlyPaymentDesc: "Payer mois par mois",
    ...
    allGradesEligible: "Tous les niveaux éligibles",

    // Eligibility rule editor
    editEligibility: "Modifier l'éligibilité",
    eligibilityRules: "Règles d'éligibilité",
    eligibilityRulesDescription: "Définir quels niveaux peuvent s'inscrire à ce club",
    ruleType: "Type de règle",
    allGradesAllowed: "Tous les niveaux autorisés",
    includeOnlyGrades: "Niveaux spécifiques uniquement",
    excludeGradesRule: "Tous sauf niveaux spécifiques",
    allGradesHint: "Tout élève peut s'inscrire à ce club",
    includeOnlyHint: "Seuls les élèves des niveaux sélectionnés peuvent s'inscrire",
    excludeGradesHint: "Les élèves des niveaux sélectionnés ne peuvent pas s'inscrire",
    selectAllowedGrades: "Sélectionner les niveaux autorisés",
    selectExcludedGrades: "Sélectionner les niveaux à exclure",
    selectedGradesCount: "{count} niveau(x) sélectionné(s)",
    updateEligibility: "Mettre à jour l'éligibilité",
    onlyGrades: "Uniquement",
    excludeGrades: "Sauf",
    eligibilityUpdated: "Règles d'éligibilité mises à jour avec succès",
