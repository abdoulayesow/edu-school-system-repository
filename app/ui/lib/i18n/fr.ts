...
export const fr = {
  ...
  accounting: {
    ...
    modifyFiltersOrRecord: "Modifiez vos filtres ou enregistrez un nouveau paiement",
    showing: "Affichage",
    of: "sur",
    results: "résultats",

    // Search
    searchPlaceholder: "Rechercher par nom, reçu ou référence...",
    searchByStudent: "Rechercher par nom d'élève",
    searchByReceipt: "Rechercher par numéro de reçu",
    ...
    viewPaymentDetails: "Voir les détails du paiement",
    paymentDetails: "Détails du paiement",

    // Accessibility
    filterPanel: "Panneau de filtres",
    statsSection: "Section des statistiques",
    paymentsTable: "Tableau des paiements",
    paginationControls: "Contrôles de pagination",
    openFilterMenu: "Ouvrir le menu des filtres",
    closeFilterMenu: "Fermer le menu des filtres",
    sortBy: "Trier par",
    ...
    studentInfo: "Informations sur l'étudiant",
    studentInformation: "Informations sur l'étudiant",
    genderMale: "Masculin",
    genderFemale: "Féminin",
    transactionDetails: "Détails de la transaction",
    paymentBreakdown: "Détails du paiement",
    originalAmount: "Montant original",
    totalTuitionFee: "Frais de scolarité total",
    amountPaid: "Montant payé",
    ...
    reviewedAt: "Vérifié le",
    paymentNotes: "Notes de paiement",
    noNotesProvided: "Aucune note fournie",
    paymentNotFound: "Paiement introuvable",
    errorLoadingPayment: "Erreur lors du chargement des détails du paiement",
    cannotEditConfirmed: "Impossible de modifier les paiements confirmés",
    confirmReverse: "Êtes-vous sûr de vouloir annuler cette transaction ?",
    reverseSuccess: "Transaction annulée avec succès",
    reverseError: "Échec de l'annulation de la transaction",
    loadingPaymentDetails: "Chargement des détails du paiement...",

    // Edit Payment Dialog
    editPaymentTitle: "Modifier le paiement",
    editPaymentDescription: "Modifiez les détails du paiement ci-dessous",
    amountLabel: "Montant (GNF)",
    receiptNumberLabel: "Numéro de reçu",
    transactionRefLabel: "Référence de transaction",
    transactionRefOptional: "Référence de transaction (facultatif)",
    notesLabel: "Notes",
    ...
    reversePaymentTitle: "Annuler le paiement",
    reversePaymentDescription: "Cette action annulera le paiement et mettra à jour les soldes de la trésorerie.",
    reversePaymentWarning: "Cette action est irréversible. Le statut du paiement sera changé en 'annulé' et les soldes de la trésorerie seront mis à jour.",
    reasonForReversal: "Raison de l'annulation",
    reasonPlaceholder: "Expliquez pourquoi ce paiement doit être annulé...",
    minimumReasonLength: "La raison doit contenir au moins 10 caractères",
  },
  ...
  expenses: {
    ...
    expenseId: "ID de la dépense",
    expenseAmount: "Montant de la dépense",
    expenseInformation: "Informations sur la dépense",
    ...
    expenseMarkedPaid: "Dépense marquée comme payée",
    backToExpenses: "Retour aux dépenses",
    expenseNotFound: "Dépense introuvable",
    errorLoadingExpense: "Échec du chargement des détails de la dépense",
    ...
    otherSupplier: "Autre (personnalisé)",
    customSupplierName: "Nom du fournisseur personnalisé",
    supplierPlaceholder: "Entrez le nom du fournisseur",
    initiatedBy: "Initié par",
    selectInitiator: "Sélectionner qui a initié cette dépense",
    self: "Moi-même",
    billingReference: "Référence de facturation",
    billingReferencePlaceholder: "Numéro de facture ou de reçu",
    receiptFile: "Fichier de reçu",
    uploadReceiptFile: "Télécharger le reçu",
    receiptUploaded: "Reçu téléchargé",
    receiptOptionalFile: "Télécharger une image ou un document de reçu (optionnel)",
    downloadPdf: "Télécharger le reçu PDF",
    supplierInformation: "Informations sur le fournisseur",
    initiatorInformation: "Informations sur l'initiateur",
  ...
  expenseWizard: {
    ...
    expenseDetails: "Détails de la dépense",
    amountAndMethod: "Montant et mode de paiement",
    receiptDocumentation: "Reçu et documentation",
    reviewExpense: "Réviser la dépense",
    expenseSummary: "Résumé de la dépense",
    submit: "Créer la dépense",
    expenseCreated: "Dépense créée avec succès !",
    viewExpense: "Voir la dépense",
    createAnother: "Créer une autre",
    backToExpenses: "Retour aux dépenses",
    categoryDescriptions: {
      supplies: "Fournitures de bureau, matériaux et consommables",
      maintenance: "Entretien des bâtiments, réparations et maintenance",
      utilities: "Électricité, eau, internet et autres services publics",
      salary: "Salaires et rémunérations du personnel",
      transport: "Frais de transport et de véhicules",
      communication: "Téléphone, internet et frais de communication",
      other: "Autres dépenses diverses",
    },
    registryClosed: "Le registre est fermé. Les transactions en espèces ne sont pas disponibles.",
    insufficientFunds: "Fonds insuffisants pour cette transaction.",
    currentBalance: "Solde actuel",
    newBalance: "Nouveau solde après transaction",
    transactionReference: "Référence de transaction",
    transactionRefRequired: "La référence de transaction est requise pour Orange Money",
    receiptUrl: "URL du reçu",
    receiptOptional: "Facultatif : Ajouter un lien vers le reçu ou la documentation",
    notes: "Notes supplémentaires",
    notesOptional: "Facultatif : Ajouter des notes ou commentaires supplémentaires",
    editStep: "Modifier",
  },
  ...
  clubEnrollmentWizard: {
    ...
    unsavedChangesDescription: "Vous avez des modifications non enregistrées",
    unsavedChangesMessage: "Êtes-vous sûr de vouloir quitter ? Toutes vos modifications seront perdues.",
    stayAndContinue: "Rester et continuer",
    ...
    selectClubDescription: "Choisissez le club dans lequel vous souhaitez inscrire un élève",
    allClubs: "Tous les clubs",
    allCategories: "Toutes les catégories",
    searchClubs: "Rechercher des clubs...",
    noClubsFound: "Aucun club trouvé",
    ...
    leader: "Responsable",
    enrollmentFee: "Frais d'inscription",
    enrollmentFeeOneTime: "Frais d'inscription (unique)",
    monthlyFee: "Frais mensuels",
    fee: "Frais",
    free: "Gratuit",
    perMonth: "/mois",
    ...
    capacityNote: "Ce club est à {percentage}% de sa capacité ({current}/{capacity} places occupées). Inscrivez-vous rapidement car les places sont limitées.",

    // Step 2 - Student Selection
    selectStudent: "Sélectionner l'élève",
    selectStudentDescription: "Choisissez un élève éligible à inscrire dans ce club",
    searchStudents: "Rechercher par nom ou numéro d'élève...",
    loadingStudents: "Chargement des élèves éligibles...",
    unableToLoadStudents: "Impossible de charger les élèves",
    retry: "Réessayer",
    noStudentsFound: "Aucun élève éligible trouvé",
    noStudentsYet: "Aucun élève éligible pour le moment",
    noStudentsMatch: "Aucun élève ne correspond à votre recherche",
    noStudentsEligibilityNote: "Les élèves doivent répondre aux critères d'éligibilité du club tels que le niveau scolaire et le statut d'inscription.",
    noStudentsSearchNote: "Essayez d'ajuster votre recherche ou le filtre de classe pour trouver plus d'élèves.",
    ...
    gradeFilter: "Classe :",
    allGrades: "Toutes les classes",
    studentsFound: "{count} élève trouvé",
    studentsFoundPlural: "{count} élèves trouvés",
    ...
    currentClubs: "Clubs actuels",
    activeClubs: "{count} club actif",
    activeClubsPlural: "{count} clubs actifs",
    noCurrentClubs: "Aucune adhésion au club",
    selectThisStudent: "Sélectionner cet élève",
    confirmSelection: "Confirmer la sélection",
    selected: "Sélectionné",
    quickSelect: "Sélectionner",
    ...
    viewAllStudents: "Voir les {count} élèves",
    showLess: "Voir moins",
    showingAllStudents: "Affichage des {count} élèves",
    capacityReached: "Ce club a atteint sa capacité maximale ({capacity} élèves). Aucune inscription supplémentaire ne peut être traitée pour le moment.",

    // Step 3 - Payment & Review
    reviewAndPayment: "Révision et paiement",
    reviewDescription: "Vérifiez les détails de l'inscription et enregistrez le paiement (optionnel)",
    clubSummary: "Détails du club",
    studentSummary: "Détails de l'élève",
    edit: "Modifier",
    clubName: "Nom du club",
    students: "élèves",
    feeBreakdown: "Détail des frais",
    reset: "Réinitialiser",
    totalMonthlyFees: "Total des frais mensuels ({months} × {amount})",
    monthsRemaining: "{remaining} sur {total} mois restants.",
    proratedAmount: "Montant au prorata :",
    adjustedTotalAmount: "Montant total ajusté",
    originalTotal: "Total original :",
    prorated: "Au prorata :",
    totalAmount: "Montant total",
    fullYear: "(Année complète)",
    viewMonthlyBreakdown: "Voir le détail mensuel ({count} mois)",
    current: "Actuel",
    past: "Passé",

    // Payment section
    recordPayment: "Enregistrer le paiement (Optionnel)",
    paymentOptionalNote: "Vous pouvez enregistrer le paiement maintenant ou plus tard. Si le paiement n'est pas enregistré, l'inscription sera sauvegardée en attente de paiement.",
    paymentAmount: "Montant du paiement",
    paymentAmountHelp: "Entrez le montant payé (peut être un paiement partiel)",
    paymentMethod: "Mode de paiement",
    cash: "Espèces",
    orangeMoney: "Orange Money",
    receiptNumber: "Numéro de reçu",
    ...
    whoIsPaying: "Qui effectue ce paiement ?",
    father: "Père",
    mother: "Mère",
    enrollingPerson: "Personne inscrivante",
    other: "Autre",
    payerName: "Nom du payeur",
    fullName: "Nom complet",
    ...
    notesPlaceholder: "Ajoutez des notes supplémentaires sur cette inscription...",
    required: "requis",

    // Proration dialog
    midYearProration: "Inscription en milieu d'année détectée",
    midYearQuestion: "Ajuster le montant total pour les mois restants ?",
    midYearInfo: "Ce club a commencé le {startDate}, mais nous inscrivons l'élève aujourd'hui. {passedMonths} mois est déjà passé.",
    midYearInfoPlural: "Ce club a commencé le {startDate}, mais nous inscrivons l'élève aujourd'hui. {passedMonths} mois sont déjà passés.",
    fullYearTotal: "Total année complète :",
    monthsPassed: "Mois écoulés :",
    monthsRemainingLabel: "Mois restants :",
    proratedAmountLabel: "Montant au prorata :",
    proratedCalculation: "Frais d'inscription ({enrollmentFee}) + Frais mensuels pour {months} mois restants",
    useProratedAmount: "Utiliser le montant au prorata ({amount})",
    keepFullAmount: "Garder le montant année complète ({amount})",
    adjustTotalManually: "Vous pouvez toujours ajuster le total manuellement avec le bouton \"Ajuster le total\"",
    ...
    noPaymentMessage: "Cette inscription sera créée sans paiement initial. Le paiement peut être enregistré ultérieurement.",
    additionalNotes: "Notes supplémentaires",
    confirmingEnrollment: "Soumission en cours...",
    ...
    missingEnrollmentData: "Données d'inscription manquantes",
    failedToSave: "Échec de l'enregistrement de l'inscription",
    failedToSubmit: "Échec de la soumission de l'inscription",
    clubAndStudentRequired: "Le club et l'élève doivent être sélectionnés avant l'enregistrement",
  ...
  roleManagement: {
    ...
    subtitle: "Gérer les rôles et permissions des utilisateurs du système",
    ...
    confirmRoleChangeMessage: "Voulez-vous vraiment changer le rôle de {userName} de {currentRole} à {newRole}?",
    cannotRemoveOwnOwnerRole: "Vous ne pouvez pas retirer votre propre rôle Propriétaire",
    selectNewRole: "Sélectionner un nouveau rôle",
    permissionsFor: "Permissions pour {role}",
    noPermissions: "Aucune permission configurée pour ce rôle",
    ...
    // Role names
    roles: {
      proviseur: "Proviseur (Secondaire)",
      censeur: "Censeur",
      surveillant_general: "Surveillant Général",
      directeur: "Directeur (Primaire)",
    ...
    // Role descriptions
    roleDescriptions: {
      proviseur: "Supervision complète de l'enseignement secondaire",
      censeur: "Programmes académiques et gestion des enseignants",
      surveillant_general: "Discipline et supervision quotidienne",
      directeur: "Supervision complète de l'enseignement primaire et maternelle",
      secretariat: "Support administratif et traitement des inscriptions",
      comptable: "Gestion financière et supervision de la trésorerie",
      agent_recouvrement: "Collecte des frais et suivi des paiements",
      coordinateur: "Coordination des opérations inter-niveaux",
      enseignant: "Enseignement et notation de ses propres classes",
      professeur_principal: "Enseignant titulaire avec supervision de classe",
      gardien: "Sécurité du campus (accès système minimal)",
      proprietaire: "Accès suprême avec gestion complète des permissions",
      admin_systeme: "Gestion technique et accès système complet",
    },

    // Permission resources
    resources: {
      students: "Élèves",
      student_enrollment: "Inscription élèves",
      student_transfer: "Transferts élèves",
      student_documents: "Documents élèves",
      classes: "Classes",
      subjects: "Matières",
      academic_year: "Année scolaire",
      teachers_assignment: "Affectation enseignants",
      schedule: "Emploi du temps",
      club_enrollment: "Inscription clubs",
      grades: "Notes",
      report_cards: "Bulletins",
      grade_approval: "Approbation notes",
      attendance: "Présence",
      attendance_justification: "Justification absence",
      discipline_records: "Dossiers discipline",
      sanctions: "Sanctions",
      fee_structure: "Structure frais",
      fee_assignment: "Affectation frais",
      student_balance: "Solde élèves",
      payment_recording: "Enregistrement paiements",
      receipts: "Reçus",
      safe_balance: "Solde caisse",
      safe_income: "Revenus caisse",
      safe_expense: "Dépenses caisse",
      bank_transfers: "Virements bancaires",
      daily_verification: "Vérification quotidienne",
      financial_reports: "Rapports financiers",
      staff: "Personnel",
      staff_assignment: "Affectation personnel",
      user_accounts: "Comptes utilisateurs",
      role_assignment: "Affectation rôles",
      permission_overrides: "Surcharge permissions",
      sms: "Messagerie SMS",
      announcements: "Annonces",
      academic_reports: "Rapports académiques",
      attendance_reports: "Rapports présence",
      financial_analytics: "Analytique financière",
    ...
    scopes: {
      all: "Tous",
      own_level: "Propre niveau",
      own_classes: "Propres classes",
      own_children: "Propres enfants",
      none: "Aucun",
    },
  },
  rolePermissions: {
    ...
    roleList: {
      ...
      loading: "Chargement des permissions de rôle...",
    },
    roleEditor: {
      title: "Permissions",
      description: "Gérer les permissions de base pour ce rôle",
      backToRoles: "Retour aux Rôles",
      roleInfo: "Informations sur le Rôle",
      permissionStats: "Statistiques des Permissions",
      totalPermissions: "Total des Permissions",
      seededPermissions: "Permissions Initialisées",
      customPermissions: "Permissions Personnalisées",
      ...
      updateScope: "Modifier la Portée",
      copyFrom: "Copier Depuis un Autre Rôle",
      selectSourceRole: "Sélectionner le rôle source",
      copyPermissions: "Copier les Permissions",
      confirmCopy: "Confirmer la Copie",
      copyMessage: "Copier toutes les permissions du rôle sélectionné ? Les permissions existantes seront préservées.",
      copy: "Copier",
      cancel: "Annuler",
      permissionAdded: "Permission ajoutée avec succès",
      permissionDeleted: "Permission supprimée avec succès",
      scopeUpdated: "Portée modifiée avec succès",
      permissionsCopied: "Permissions copiées avec succès",
      ...
      copyResults: {
        added: "Ajoutées",
        skipped: "Ignorées (déjà existantes)",
        errors: "Erreurs",
      },
    },
    roles: {
  ...
  permissionOverrides: {
    ...
    roleBaseline: "Ligne de Base du Rôle",
    ...
    denyPermission: "Refuser la Permission",
    confirmGrant: "Confirmer l'Accord",
    confirmDeny: "Confirmer le Refus",
    confirmRemove: "Confirmer la Suppression",
    grantMessage: "Accorder cette permission à l'utilisateur même si son rôle ne l'inclut pas?",
    denyMessage: "Refuser cette permission même si le rôle de l'utilisateur l'inclut?",
    removeMessage: "Supprimer cette surcharge et revenir au défaut du rôle?",
    grant: "Accorder",
    deny: "Refuser",
    remove: "Supprimer",
    cancel: "Annuler",
    fromRole: "Du Rôle",
    granted: "Accordée",
    denied: "Refusée (Masquée)",
    overrideAdded: "Surcharge ajoutée avec succès",
    overrideRemoved: "Surcharge supprimée avec succès",
    noPermissions: "Aucune permission trouvée",
    noOverrides: "Aucune surcharge configurée",
    overrideCount: "surcharge(s)",
    viewingAs: "Visualisation des permissions pour",
    createdBy: "Créé par",
    createdAt: "Créé le",
    effectPermissionCount: "Permissions Effectives",
    rolePermissionCount: "Permissions du Rôle",
    overridesCount: "Surcharges Actives",
    grantsCount: "Accords",
    denialsCount: "Refus",
    permissionKey: "Permission",
    source: "Source",
    ...
    dangerZoneDescription: "Les refus de permission empêchent l'accès même si le rôle l'accorde",
    errors: {
