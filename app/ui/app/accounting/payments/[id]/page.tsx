  ...
  return (
    <>
      ...
      <PageContainer maxWidth="full" className="space-y-6">
        ...
        {/* Receipt Card */}
        <Card className="print-area overflow-hidden shadow-lg bg-white dark:bg-card relative hover:shadow-xl transition-shadow duration-300 border">
            ...
            >
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className={cn(
                  ...
                  isClubPayment ? "text-purple-900 dark:text-purple-100" : "text-gspn-maroon-900 dark:text-gspn-maroon-100"
                )}>
                  ...
                  <Badge
                    ...
                    className={cn(
                      ...
                      isClubPayment
                        ...
                        : "border-gspn-maroon-400 bg-gspn-maroon-100 text-gspn-maroon-800 dark:border-gspn-maroon-600 dark:bg-gspn-maroon-950/70 dark:text-gspn-maroon-200"
                    )}
                  >
                    {isClubPayment ? (
            ...
            <div className="no-print pt-10 border-t-2 border-slate-200 dark:border-slate-700 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 justify-center">
                <Button
                  onClick={handlePrint}
                  size="lg"
                  className="gap-3 shadow-lg hover:shadow-xl transition-all group font-semibold bg-gspn-gold-500 text-black hover:bg-gspn-gold-400"
                >
                ...
                <div className="flex gap-3">
                  ...
                  {payment.status !== "confirmed" && (
                    <Button
                      variant="outline"
                      size="lg"
                      className="gap-2 shadow-md hover:shadow-lg transition-all flex-1 sm:flex-initial font-medium border-2 border-gspn-maroon-300 dark:border-gspn-maroon-700 hover:bg-gspn-maroon-50 dark:hover:bg-gspn-maroon-950/30"
