...
const DEFAULT_PERMISSIONS: PermissionDef[] = [
  ...
  // ========================================================================
  // PROPRIETAIRE (Owner)
  // Supreme access - all permissions including permission management (all scope)
  // ========================================================================
  { role: StaffRole.proprietaire, resource: PermissionResource.students, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.students, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.students, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.students, action: PermissionAction.delete, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.student_enrollment, action: PermissionAction.create, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.student_documents, action: PermissionAction.update, scope: PermissionScope.all },

  { role: StaffRole.proprietaire, resource: PermissionResource.classes, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.classes, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.classes, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.classes, action: PermissionAction.delete, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.subjects, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.subjects, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.subjects, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.subjects, action: PermissionAction.delete, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.academic_year, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.academic_year, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.academic_year, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.teachers_assignment, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.teachers_assignment, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.schedule, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.schedule, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.schedule, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.club_enrollment, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.club_enrollment, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.club_enrollment, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.club_enrollment, action: PermissionAction.delete, scope: PermissionScope.all },

  { role: StaffRole.proprietaire, resource: PermissionResource.grades, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.grades, action: PermissionAction.update, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.report_cards, action: PermissionAction.export, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.grade_approval, action: PermissionAction.approve, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.attendance, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.attendance_justification, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.attendance_justification, action: PermissionAction.approve, scope: PermissionScope.all },

  { role: StaffRole.proprietaire, resource: PermissionResource.discipline_records, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.sanctions, action: PermissionAction.view, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.fee_structure, action: PermissionAction.create, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.fee_assignment, action: PermissionAction.update, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.payment_recording, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.payment_recording, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.receipts, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.receipts, action: PermissionAction.create, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_balance, action: PermissionAction.update, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_income, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_income, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_income, action: PermissionAction.delete, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_expense, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_expense, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_expense, action: PermissionAction.delete, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.safe_expense, action: PermissionAction.approve, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.bank_transfers, action: PermissionAction.create, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.daily_verification, action: PermissionAction.create, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.staff, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.staff, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.staff_assignment, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.staff_assignment, action: PermissionAction.update, scope: PermissionScope.all },

  // USER & PERMISSION MANAGEMENT - Owner can manage users and permissions
  { role: StaffRole.proprietaire, resource: PermissionResource.user_accounts, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.user_accounts, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.user_accounts, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.user_accounts, action: PermissionAction.delete, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.role_assignment, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.role_assignment, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.permission_overrides, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.permission_overrides, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.permission_overrides, action: PermissionAction.delete, scope: PermissionScope.all },

  { role: StaffRole.proprietaire, resource: PermissionResource.sms, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.announcements, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.announcements, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.announcements, action: PermissionAction.delete, scope: PermissionScope.all },
  ...
  { role: StaffRole.proprietaire, resource: PermissionResource.system_settings, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.system_settings, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.audit_logs, action: PermissionAction.view, scope: PermissionScope.all },
  { role: StaffRole.proprietaire, resource: PermissionResource.audit_logs, action: PermissionAction.export, scope: PermissionScope.all },
  ...
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_income, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_income, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_income, action: PermissionAction.delete, scope: PermissionScope.all },
  ...
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_expense, action: PermissionAction.create, scope: PermissionScope.all },
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_expense, action: PermissionAction.update, scope: PermissionScope.all },
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_expense, action: PermissionAction.delete, scope: PermissionScope.all },
  { role: StaffRole.admin_systeme, resource: PermissionResource.safe_expense, action: PermissionAction.approve, scope: PermissionScope.all },
