...
This document describes the internationalization setup for the School Management System. The application supports **French (default)** and **English** languages, designed specifically for the Groupe Scolaire GSN N'Diolou school in Guinea.
